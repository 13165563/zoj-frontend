          ...
          <a-card class="question-card">
            ...
            <div class="comments-section">
              ...
              <div class="comment-form">
                <a-textarea v-model="commentContent" placeholder="请输入您的评论..." :auto-size="{ minRows: 2, maxRows: 4 }" />
                <div class="comment-actions">
                  <a-button type="primary" @click="submitComment" :disabled="!commentContent">发表评论</a-button>
                </div>
              </div>
          ...
          <a-card class="code-card">
            ...
            <div class="code-editor-container">
              <div class="language-selector">
                <a-select v-model="selectedLanguage" :style="{ width: '150px' }" placeholder="选择编程语言">
...
const submitCode = async () => {
  ...
  try {
    const res = await doQuestionSubmit({
      questionId: question.value.id!.toString(), // 转换为字符串避免精度问题
